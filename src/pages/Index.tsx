        ...
        <nav className="relative z-10 container mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-primary">DISC Comercial 10X</span>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              Por que escolher o <span className="text-primary">DISC da Conversão</span>?
            </h2>
      ...
      <section className="py-24 bg-card relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Button asChild size="lg" className="bg-primary text-primary-foreground hover:bg-primary-hover shadow-gold text-lg px-12 py-6 transition-smooth">
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-primary">DISC da Conversão</span>
            </div>
            <p className="text-muted-foreground text-sm">
              © 2025 DISC da Conversão. Todos os direitos reservados.
            </p>
